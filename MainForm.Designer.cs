namespace RSATool
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.btnLoadPubKey = new System.Windows.Forms.Button();
			...
			this.btnEncrypt.Location = new System.Drawing.Point(580, 13);
			this.btnEncrypt.Name = "btnEncrypt";
			this.btnEncrypt.Size = new System.Drawing.Size(100, 23);
			this.btnEncrypt.TabIndex = 1;
			this.btnEncrypt.Text = "加密文本(&E)";
			...
			this.btnDecrypt.Location = new System.Drawing.Point(686, 13);
			this.btnDecrypt.Name = "btnDecrypt";
			this.btnDecrypt.Size = new System.Drawing.Size(100, 23);
			this.btnDecrypt.TabIndex = 2;
			this.btnDecrypt.Text = "解密文本(&D)";
			...
			// tpAbout
			// 
			this.tpAbout.Controls.Add(this.pnlAbout);
			this.tpAbout.Location = new System.Drawing.Point(4, 22);
			this.tpAbout.Name = "tpAbout";
			this.tpAbout.Padding = new System.Windows.Forms.Padding(3);
			this.tpAbout.Size = new System.Drawing.Size(785, 528);
			...
			// pnlAbout
			// 
			this.pnlAbout.Controls.Add(this.rtfAbout);
			...
			this.pnlAbout.Size = new System.Drawing.Size(779, 522);
			...
			this.rtfAbout.Location = new System.Drawing.Point(20, 20);
			this.rtfAbout.Name = "rtfAbout";
			this.rtfAbout.ReadOnly = true;
			this.rtfAbout.Size = new System.Drawing.Size(739, 482);
			this.rtfAbout.TabIndex = 1;
			this.rtfAbout.Text = "";
			this.rtfAbout.LinkClicked += new System.Windows.Forms.LinkClickedEventHandler(this.rtfAbout_LinkClicked);
			// 
			// btnLoad
			// 
			...
			this.btnLoad.Text = "加载私钥(&L)";
			this.btnLoad.UseVisualStyleBackColor = true;
			this.btnLoad.Click += new System.EventHandler(this.btnLoad_Click);
			// 
			// pnlBottom
			// 
			this.pnlBottom.Controls.Add(this.btnLoadPubKey);
			this.pnlBottom.Controls.Add(this.btnDecFile);
			this.pnlBottom.Controls.Add(this.btnEncFile);
			...
			// btnDecFile
			// 
			this.btnDecFile.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
			this.btnDecFile.Location = new System.Drawing.Point(475, 13);
			this.btnDecFile.Name = "btnDecFile";
			this.btnDecFile.Size = new System.Drawing.Size(100, 23);
			this.btnDecFile.TabIndex = 6;
			this.btnDecFile.Text = "解密文件(&X)...";
			this.btnDecFile.UseVisualStyleBackColor = true;
			this.btnDecFile.Click += new System.EventHandler(this.btnDecFile_Click);
			// 
			// btnEncFile
			// 
			this.btnEncFile.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
			this.btnEncFile.Location = new System.Drawing.Point(369, 13);
			this.btnEncFile.Name = "btnEncFile";
			this.btnEncFile.Size = new System.Drawing.Size(100, 23);
			this.btnEncFile.TabIndex = 5;
			this.btnEncFile.Text = "加密文件(&F)...";
			this.btnEncFile.UseVisualStyleBackColor = true;
			this.btnEncFile.Click += new System.EventHandler(this.btnEncFile_Click);
			// 
			// btnLoadPubKey
			// 
			this.btnLoadPubKey.Location = new System.Drawing.Point(194, 13);
			this.btnLoadPubKey.Name = "btnLoadPubKey";
			this.btnLoadPubKey.Size = new System.Drawing.Size(85, 23);
			this.btnLoadPubKey.TabIndex = 7;
			this.btnLoadPubKey.Text = "对方公钥(&P)";
			this.btnLoadPubKey.UseVisualStyleBackColor = true;
			this.btnLoadPubKey.Click += new System.EventHandler(this.btnLoadPubKey_Click);
			// 
			// MainForm
			// 
		...
		private System.Windows.Forms.Button btnLoadPubKey;
	}
}
